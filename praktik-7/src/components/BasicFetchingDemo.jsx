// src/components/BasicFetchingDemo.jsx
  ...
  return (
    <div className="basic-fetching-demo">
      ...
      <div className="control-buttons">
        <button onClick={refetchData} disabled={loading} className="btn btn-primary">
          {loading ? 'Memuat...' : 'Refresh Data'}
        </button>
        <button onClick={fetchWithError} disabled={loading} className="btn btn-warning">
          Simulasi Error
        </button>
      </div>
